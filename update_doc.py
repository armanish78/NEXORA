content = """# Antigravity Study Assistant: The Core Brain Master Document
...
- **Hardware:** Running the AI requires a good computer with a GPU and at least 8GB of RAM.
...
"""
with open("/home/nova/Desktop/RAG/doc.md", "w") as f:
    f.write(content)
